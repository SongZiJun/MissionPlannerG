...
using WebCamService;
using MissionPlanner.Joystick;      //宋子君 2017/12/25  新增游戏摇杆按钮点击事件
...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //MyView.AddScreen(new MainSwitcher.Screen("SWConfig", typeof(GCSViews.SoftwareConfig), false));  控制SoftwareConfig主体是否显示  （宋子君）  2017/12/24
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (keyData == (Keys.Control | Keys.F)) // temp  crtl+F
            {
                Form frm = new temp();
