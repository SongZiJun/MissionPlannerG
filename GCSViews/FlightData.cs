...
// square
        ...
        private void SwapHud1AndMap()
        {
            ...
            if (this.SubMainLeft.Panel1.Controls.Contains(hud1))
            {
                ...
                //SubMainLeft.Panel1.Controls.Add(tableMap);wf
            }
            else
            {
                //MainH.Panel2.Controls.Add(tableMap);
                //SubMainLeft.Panel1.Controls.Add(hud1); wf
            }
        ...
        private void SubMainLeft_Panel1_Paint(object sender, PaintEventArgs e)
        {
