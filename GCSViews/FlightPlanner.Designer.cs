...
namespace MissionPlanner.GCSViews
{
    partial class FlightPlanner
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.BUT_georefimage = new MissionPlanner.Controls.MyButton();  //定义新增按钮  （宋子君）  2017/12/24
            ...
            this.panel2.Controls.Add(this.BUT_georefimage);     ////定义新增按钮  （宋子君）    2017/12/24
            ...
            this.lbl_wpfile.Click += new System.EventHandler(this.lbl_wpfile_Click);
            // 
            // BUT_loadwpfile
            // 
        ...
        private Controls.MyButton BUT_saveWPFile;    // 控制保存航点文件   （宋子君）     2017/12/24
        private Controls.MyButton BUT_georefimage;  //新添按钮  （宋子君）      2017/12/24
