    ...
    internal class KmlFormatter : ICustomFormatter, IFormatProvider
    {
        ...
        public string Format(string format, object arg, IFormatProvider formatProvider)
        {
            ...
            if (format == null)
            {
                ...
                if (date != null)
                {
                    // return date.Value.ToString("yyyy-MM-ddTHH:mm:sszzzzzz", CultureInfo.InvariantCulture); wf 2017-8-3
                    return date.Value.ToString("o", CultureInfo.InvariantCulture);
                }
