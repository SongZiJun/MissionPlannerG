        ...
        void doPaint(PaintEventArgs e)
        {
            ...
            try
            {
                ...
                if (displayrollpitch)
                {
                    ...
                    //foreach (int a in array) wf 以下各行注释为了删除hud中白色半弧线 2017-8-5
                    //{
                    //    graphicsObject.ResetTransform();
                    //    graphicsObject.TranslateTransform(this.Width / 2, this.Height / 2);
                ...
                if (status == false) // not armed
                {
                    ...
                    {
                        drawstring(graphicsObject, HUDT.DISARMED, font, fontsize + 10, (SolidBrush)Brushes.Red, -85, halfheight / -3);//hud中显示已锁定
                        statuslast = status;
                    }
                }
